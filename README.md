...
--------------------------------------------------------------------------------
**[Article](https://quva-lab.github.io/e2cnn/)** | **[Experiments](https://api.wandb.ai/links/tihstepml/54mw7gv0)** | **[Thesis Gabriele](https://gabri95.github.io/Thesis/thesis.pdf)**
...
| ---------------------------------------------------------------------------------------| ---------------------------------------------------------------- |
| [**Equivariant-models.KR**](https://github.com/Tihstep/Equivariant-models/blob/main/KR.ipynb)          | implements basic concepts of *group* and *representation* theory |
| [** Equivariant-models.models**](https://github.com/Tihstep/Equivariant-models/tree/main/models)      | solves for spaces of equivariant convolution kernels             |
| [** Equivariant-models.data**](https://github.com/Tihstep/Equivariant-models/tree/main/data)      | solves for spaces of equivariant differential operators          |
| [**Equivariant-models.data_config.yaml**](https://github.com/Tihstep/Equivariant-models/blob/main/data_config.yaml)      | defines the image plane and its symmetries                       |
| [**Equivariant-models.model_config.yaml**](https://github.com/Tihstep/Equivariant-models/blob/main/model_config.yaml)                | contains equivariant modules to build deep neural networks       |
-----------------------------------------------------------------------------------------------------------------------------------------------------------
